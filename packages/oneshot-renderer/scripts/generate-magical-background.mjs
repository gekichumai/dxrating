...
// Run from the repository root: node packages/oneshot-renderer/scripts/generate-magical-background.mjs
const source = await readFile(new URL('../../../apps/web/src/assets/magical-background.svg', import.meta.url), 'utf8')
