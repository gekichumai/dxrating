...
import { ImportFromMuNetButtonListItem } from './import/ImportFromMuNetButtonListItem'
  ...
  return (
    <>
      ...
      >
        ...
        <ImportFromMuNetButtonListItem modifyEntries={modifyEntries} onClose={handleClose} />
