...
export const LoginForm = () => {
  ...
  return (
    <Box className="flex flex-col gap-4 w-full p-4">
      ...
      <Button variant="outlined" startIcon={<MdiGoogle />} onClick={() => handleSocial('google')} disabled={loading}>
        Continue with Google
      </Button>
      <Button variant="outlined" startIcon={<MdiGithub />} onClick={() => handleSocial('github')} disabled={loading}>
      ...
      <Button variant="outlined" startIcon={<IconMdiFingerprint />} onClick={handlePasskey} disabled={loading}>
