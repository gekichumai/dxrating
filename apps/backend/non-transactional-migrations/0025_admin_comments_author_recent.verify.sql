SELECT COALESCE((
  SELECT index.indisvalid
    ...
    AND index.indoption::text = '0 1 1'
    AND access_method.amname = 'btree'
    AND pg_get_indexdef(index.indexrelid, 1, true) = 'created_by'
    ...
    ) = ARRAY['text_ops', 'timestamp_ops', 'int8_ops']::name[]
  FROM pg_index index
  ...
  WHERE index_namespace.nspname = 'public'
    AND index_relation.relname = 'admin_comments_author_recent_idx'
